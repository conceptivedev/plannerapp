...
import com.conceptive.planner.domain.JobHistory;
import com.conceptive.planner.repository.JobHistoryRepository;
import com.conceptive.planner.service.JobHistoryService;
import com.conceptive.planner.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.conceptive.planner.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
